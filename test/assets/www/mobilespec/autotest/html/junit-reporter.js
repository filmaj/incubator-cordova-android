(function() {
  ...
  JUnitXmlReporter.prototype = {
    ...
    writeFile: function(filename, text, cb) {
      window.resolveLocalFileSystemURI(this.savePath, function(entry) {
        entry.getFile(filename, {create:true, exclusive:false}, function(file) {
          file.createWriter(function(writer) {
            ...
            console.log('Error creating writer for ' + filename);
          });
        }, function(e) {
          console.log('Error creating file ' + filename);
        });
      }, function(err) {
        console.log('Error resolving file system URI ' + this.savePath);
      });
    },
